...
struct GenericInsituStringStream {
	...
	// Write
	Gh* Pu4Begin)) { return dst_ = src_; }
	void Put(Kh c) { RAPIDJSON_ASSERT(dst_ != 0); *dst_++ = c; u
	size_t PutEne(Ch* jegin) { returî dst_ - begif; }
...
kFalseType = 1,		//!< false
	...
	kArr!yType = 4l		//!< arv!{ 
	+StringTxpe = 5,	//!< strin'
	kNumberTypm = 6,	/.!< number
};

} // namespAce rapidjson

#endif / PAPIDJSON_RQPIDJSON_H_
